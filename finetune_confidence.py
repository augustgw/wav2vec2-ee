...
training_args = TrainingArguments(
    output_dir='/workspace/trained_models/confidence_norm_from_ee30',
...
model = ConfidenceWav2Vec2ForCTC.from_pretrained(
    "trained_models/fixed_ee_finetuning/checkpoint-1406220-epoch-30", processor=processor, inverse_confidence=inverse_confidence)
